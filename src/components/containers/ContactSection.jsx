...
import { RiMailLine, RiTelegramLine, RiWhatsappLine, RiDiscordLine } from "react-icons/ri";
    ...
    <div className="grid grid-cols-9 gap-7">
      ...
      >
        <div className="contact-information">
          ...
          <p>
            I love to make new connections. Whether you`re looking to kick off a
            new project or rebuild something that already exists, I am ready to
          ...
          <div className="contact-blocks mt-5 space-y-5">
            ...
            <div className="contact-block card flex p-4 md:p-5">
              ...
              <div className="content">
                <h5 className="mb-2">Contact on Telegram</h5>
                {data.telegram.map((telegram, index) => (
                  <p className="mb-0" key={index}>
                    <Link href={`${telegram}`}>
                      <a className="no-underline">{telegram}</a>
                    </Link>
                  </p>
                ))}
              </div>
            ...
            <div className="contact-block card flex p-4 md:p-5">
              ...
              <div className="content">
                <h5 className="mb-2">Contact on Discord</h5>
                {data.discord.map((discord, index) => (
                  <p className="mb-0" key={index}>
                    <Link href={`${discord}`}>
                      <a className="no-underline">{discord}</a>
                    </Link>
                  </p>
                ))}
              </div>
      ...
      <motion.div
        ...
        variants={childrenAnimation}
        className="col-span-9 lg:col-span-5 ml-2"
      >
        <ContactForm />
      </motion.div>
    </div>
